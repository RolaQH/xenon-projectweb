/// <reference path="E:\BoticService\V6.0\Xenon.ERP.Solution\Xenon.FronEnd.WebForm.Sales\Mantenimientos/jsSc.js" />
/// <reference path="E:\BoticService\V6.0\Xenon.ERP.Solution\Xenon.FronEnd.WebForm.Sales\Mantenimientos/jsSc.js" />
/// <reference path="E:\BoticService\V6.0\Xenon.ERP.Solution\Xenon.FronEnd.WebForm.Sales\Mantenimientos/jsSc.js" />
/// <reference path="E:\BoticService\V6.0\Xenon.ERP.Solution\Xenon.FronEnd.WebForm.Sales\Mantenimientos/jsSc.js" />
//
...
function LoadCalendarScript(callback){
	function LoadFullCalendarScript(){
		if(!$.fn.fullCalendar){
		    $.getScript('ScriptsDev/plugins/fullcalendar/fullcalendar.js', callback);
		}
		else {
	...
	if (!$.fn.moment){
	    $.getScript('ScriptsDev/plugins/moment/moment.min.js', LoadFullCalendarScript);
	}
	else {
...
function LoadTimePickerScript(callback){
	if (!$.fn.timepicker){
	    $.getScript('ScriptsDev/plugins/jquery-ui-timepicker-addon/jquery-ui-timepicker-addon.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadBootstrapValidatorScript(callback){
	if (!$.fn.bootstrapValidator){
	    $.getScript('ScriptsDev/plugins/bootstrapvalidator/bootstrapValidator.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadSelect2Script(callback){
	if (!$.fn.select2){
	    $.getScript('ScriptsDev/plugins/select2/select2.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadScriptMantenimiento(callback) {
    $.getScript("Mantenimientos/jsSc.js", callback);
    $.getScript("Scripts/FooTable-2/css/footable.core.css?v=2-0-1", callback);
    $.getScript("Scripts/FooTable-2/demos/css/footable-demos.css", callback);
    $.getScript("js/bootstrap-tab.js", callback);
    $.getScript("Scripts/FooTable-2/demos/js/demos.js", callback);
    $.getScript("Scripts/FooTable-2/js/footable.js?v=2-0-1", callback);
    $.getScript("Scripts/FooTable-2/js/footable.grid.js", callback);
    $.getScript("Scripts/FooTable-2/js/footable.sort.js", callback);
    $.getScript("Scripts/FooTable-2/js/footable.paginate.js", callback);
}
...
function LoadDataTablesScripts(callback){
	function LoadDatatables(){
	    $.getScript('ScriptsDev/plugins/datatables/jquery.dataTables.js', function () {
		    $.getScript('ScriptsDev/plugins/datatables/ZeroClipboard.js', function () {
				$.getScript('ScriptsDev/plugins/datatables/TableTools.js', function(){
				    $.getScript('ScriptsDev/plugins/datatables/dataTables.bootstrap.js', callback);
				});
			});
		});
	}
...
function LoadFineUploader(callback){
	if (!$.fn.fineuploader){
	    $.getScript('ScriptsDev/plugins/fineuploader/jquery.fineuploader-5.0.1.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadXChartScript(callback){
	function LoadXChart(){
	    $.getScript('ScriptsDev/plugins/xcharts/xcharts.min.js', callback);
	}
	function LoadD3Script(){
		if (!$.fn.d3){
		    $.getScript('ScriptsDev/plugins/d3/d3.v3.min.js', LoadXChart)
		}
		else {
			LoadXChart();
		}
...
function LoadFlotScripts(callback){
	function LoadFlotScript(){
	    $.getScript('ScriptsDev/plugins/flot/jquery.flot.js', LoadFlotResizeScript);
	}
	function LoadFlotResizeScript(){
	    $.getScript('ScriptsDev/plugins/flot/jquery.flot.resize.js', LoadFlotTimeScript);
	}
	function LoadFlotTimeScript(){
	    $.getScript('ScriptsDev/plugins/flot/jquery.flot.time.js', callback);
	}
	if (!$.fn.flot){
		LoadFlotScript();
	}
...
function LoadMorrisScripts(callback){
	function LoadMorrisScript(){
		if(!$.fn.Morris){
		    $.getScript('ScriptsDev/plugins/morris/morris.min.js', callback);
		}
		else {
			if (callback && typeof(callback) === "function") {
				callback();
	...
	if (!$.fn.raphael){
	    $.getScript('ScriptsDev/plugins/raphael/raphael-min.js', LoadMorrisScript);
	}
	else {
		LoadMorrisScript();
	}
...
function LoadFancyboxScript(callback){
	if (!$.fn.fancybox){
	    $.getScript('ScriptsDev/plugins/fancybox/jquery.fancybox.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadKnobScripts(callback){
	if(!$.fn.knob){
	    $.getScript('ScriptsDev/plugins/jQuery-Knob/jquery.knob.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadSparkLineScript(callback){
	if(!$.fn.sparkline){
	    $.getScript('ScriptsDev/plugins/sparkline/jquery.sparkline.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function TestTable3(){
	$('#datatable-3').dataTable( {
		...
		"oTableTools": {
		    "sSwfPath": "ScriptsDev/plugins/datatables/copy_csv_xls_pdf.swf",
			"aButtons": [
				"copy",
				"print",
				{
...
$(document).ready(function () {
	...
	if (ajax_url.length < 1) {
		ajax_url = 'Paginas/Mantenimientos/frmTable.aspx';
	}
