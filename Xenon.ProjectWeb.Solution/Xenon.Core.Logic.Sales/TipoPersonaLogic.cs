...
namespace Xenon.Core.Logic.Sales
{
    public class TipoPersonaLogic
    {
        ...
        private static volatile TipoPersonaLogic instance;
        private static object syncRoot = new object();

        private TipoPersonaLogic() { }

        public static TipoPersonaLogic GetInstance
        {
        ...
        #endregion
        #region Accessor
        private static TipoPersonaAccessor Accessor
        {
            [System.Diagnostics.DebuggerStepThrough]
            get { return TipoPersonaAccessor.CreateInstance(); }
        }
        #endregion
    }
}
